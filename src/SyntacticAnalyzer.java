...
public class SyntacticAnalyzer{
	...
	/*funcBlock*/		{"","","","","","","","","","","","EPSILON","","","","","","","","","","","","#pushType float #pushId id arraySizeList #newVar ; funcBlock","","for ( #pushType type #pushId %pushId id #newVar %pushDummy %checkId assignOp expr %ass ; relExpr %doneExpr ; assignStat ) statBlock ; statementList","get ( variable %doneExpr ) ; statementList","#pushType %pushId id varOrStatement","if ( expr %doneExpr ) then statBlock else statBlock ; statementList","#pushType int #pushId id arraySizeList #newVar ; funcBlock","","","","","put ( expr %doneExpr ) ; statementList","return ( expr %doneExpr ) ; statementList","","pop"},
	...
	/*statement*/		{"","","","","","","","pop","","","","pop","","","","","","","","","","","pop","","","for ( #pushType type #pushId %pushId id #newVar %pushDummy %checkId assignOp expr %ass ; relExpr %doneExpr ; assignStat ) statBlock ;","get ( variable %doneExpr ) ;","assignStat ;","if ( expr %doneExpr ) then statBlock else statBlock ;","","","","","","put ( expr %doneExpr ) ;","return ( expr %doneExpr ) ;","","pop"},
